...
:root[data-hermes-theme="hermes-telegram-neon-flow"] [data-slot="aui_thread-viewport"] { position:relative; isolation:isolate; overflow:auto; background-color:var(--dt-background)!important; background-image:url("${doodleSvg}"),radial-gradient(48rem 30rem at 50% 22%,rgba(78,164,245,.08),transparent 72%),radial-gradient(36rem 30rem at 82% 82%,rgba(233,106,178,.05),transparent 74%); background-repeat:repeat,no-repeat,no-repeat; background-size:168px 168px,auto,auto; background-position:0 0,50% 22%,82% 82%; background-attachment:scroll,scroll,scroll; animation:telegram-doodle-field 18s ease-in-out infinite alternate; }
