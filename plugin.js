...
:root[data-hermes-theme="hermes-telegram-neon-flow"] [role="dialog"],:root[data-hermes-theme="hermes-telegram-neon-flow"] [role="menu"],:root[data-hermes-theme="hermes-telegram-neon-flow"] [data-radix-popper-content-wrapper]>* { border:1px solid color-mix(in srgb,#fff 15%,var(--dt-border))!important; box-shadow:var(--night-shadow),inset 0 1px rgba(255,255,255,.16); }
:root[data-hermes-theme="hermes-telegram-neon-flow"][data-hermes-mode="light"] [role="dialog"],:root[data-hermes-theme="hermes-telegram-neon-flow"][data-hermes-mode="light"] [role="menu"],:root[data-hermes-theme="hermes-telegram-neon-flow"][data-hermes-mode="light"] [data-radix-popper-content-wrapper]>* { background:rgba(255,255,255,.88)!important; }
:root[data-hermes-theme="hermes-telegram-neon-flow"][data-hermes-mode="dark"] [role="dialog"],:root[data-hermes-theme="hermes-telegram-neon-flow"][data-hermes-mode="dark"] [role="menu"],:root[data-hermes-theme="hermes-telegram-neon-flow"][data-hermes-mode="dark"] [data-radix-popper-content-wrapper]>* { background:rgba(11,21,37,.86)!important; }
